...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default = 'D:/hand_data/handpose_x_model/ReXNetV1-size-256-loss-wing_loss102-0.115-20211108.pth',
        help = 'model_path') # 模型路径
    parser.add_argument('--test_video_path', type=str,
                        default='D:/hand_data/test_video/test_1.mp4',
    ...
    # plt.show()
    ############# 求取红色区域位置坐标 ####################
    red = red_shibie.red_i(ops.test_path)
    # print("红色区域坐标：")
    # print(red)
    # print(idx)
