...
def angel_jisuan(flag_ang, hand_joint_x, hand_joint_y, idx):
    if flag_ang == 8.7:
        ...
        for i in range(0, idx):
            deta_x = hand_joint_x[i][7] - hand_joint_x[i][8] + 0.0000000000000000000001
        ...
        angle_rad_7_6 = []
        for i in range(0, idx):
            deta_x = hand_joint_x[i][6] - hand_joint_x[i][7] + 0.0000000000000000000001
        ...
        angle_rad = []
        for i in range(0, idx):
            deta_x = hand_joint_x[i][5] - hand_joint_x[i][6] + 0.0000000000000000000001
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_video_path', type=str,
                        default='D:/hand_data/test_video/test_4.mp4',
